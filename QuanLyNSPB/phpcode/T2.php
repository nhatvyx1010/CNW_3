...
<body>
        <div class="container">
            <div class="products">
                <div class="product" ><a href="login.php" id="linkToFrame">Đăng nhập</a></div>
                <div class="product"><a href="timkiem.php" id="linkToFrame">Tìm kiếm</a></div>
                <div class="product"><a href="xemthongtinPhongban.php" id="linkToFrame">Xem thông tin phòng ban</a></div>
                <div class="product"><a href="xemthongtinNhanvien.php" id="linkToFrame">Xem thông tin nhân viên</a></div>
